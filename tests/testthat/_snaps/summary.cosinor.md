# summary print works
    ...
    Output
      ...
      X0:.main_cos1     0.87           0.63    -0.38      2.1     0.2    
      X1:.main_cos1     6.48           0.94     4.63      8.3   7e-12 ***
      X0:.main_sin1     6.24           0.68     4.91      7.6  <2e-16 ***
      X1:.main_sin1     4.67           0.91     2.89      6.4   3e-07 ***
      ---
...
---
    ...
    Output
      ...
      X0:.main_cos1      1.0            0.6     -0.3        2     0.1    
      X1:.main_cos1      6.6            1.0      4.7        8   2e-11 ***
      X0:.main_sin1      6.3            0.7      4.9        8  <2e-16 ***
      X1:.main_sin1      4.6            0.9      2.7        6   1e-06 ***
      ---
      Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
      ...
      ***********************
      ...
      X0:.disp_cos1     0.19           0.09     0.01      0.4    0.04 *  
      X1:.disp_cos1    -0.04           0.12    -0.28      0.2    0.74    
      X0:.disp_sin1     0.05           0.10    -0.14      0.2    0.60    
      X1:.disp_sin1     0.03           0.12    -0.20      0.3    0.81    
      ---
      Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
      ...
      ***********************
      ...
      X0:.zi_cos1   -2e+00          7e+03   -1e+04    13508       1
      X1:.zi_cos1    9e-02          1e+04   -2e+04    21286       1
      X0:.zi_sin1    7e-01          7e+03   -1e+04    13636       1
      X1:.zi_sin1    3e-01          1e+04   -2e+04    20486       1
