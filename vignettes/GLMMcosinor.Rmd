...
autoplot(object, superimpose.data = TRUE, x_str = "X", predict.ribbon = FALSE, data_opacity = 0.2)
```
...
-   MESOR ($M$) is the Midline Estimating Statistic of Rhythm, and may
    also referred to as the equilbrium point
...
In the single-component case, these parameters correspond to the
...
object <- cosinor.glmm(Y ~ group + amp_acro(times, period = c(12,6),n_components = 2, group = "group"), data = testdata_summary, family = poisson())
