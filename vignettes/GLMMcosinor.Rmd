...
The most important output from the `cosinor.glmm()` function is likely
to be the parameter estimates for MESOR, amplitude, and acrophase under
the 'Transformed Coefficients' heading. A detailed explanation of the
...
-   `[X=0]:acr = -1.42181` is the acrophase estimate for group 0

-   `[X=1]:acr = -0.63715` is the acrophase estimate for group 1
