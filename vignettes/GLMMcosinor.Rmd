...
These original parameters can be recovered: for amplitude ($A$) and
...
$$\hat A = \sqrt{\hat\beta ^2 + \hat\gamma ^ 2}$$ For a more thorough
introduction to cosinor modelling, see
[here](https://doi.org/10.1186%2F1742-4682-11-16)
