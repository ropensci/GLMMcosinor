...
dat_list <- list(
  list(
    ...
    zi = TRUE,
    rhythmdiff = FALSE,
    family = "Any family listed in glmmTMB (See ?family_glmmTMB)",
    ref = "Parsons, 2023"
  ),
  list(
    name = "CosinorPy",
    ...
    zi = FALSE,
    rhythmdiff = TRUE,
    family = "Gaussian, Poisson, negative-binomial",
    ref = "Moskon, 2020"
  ),
  list(
    name = "RhythmCount",
    ...
    zi = TRUE,
    rhythmdiff = FALSE,
    family = "Poisson, generalised Poisson, zero-inflated Poisson, negative binomial, zero-inflated negative-binomial",
    ref = "Velikajne, 2022"
  )
)
...
dat <- flextable::color(
  dat, 
  j = c("multicomponent", "disp", "zi", "rhythmdiff"), 
