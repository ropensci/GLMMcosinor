...
be accessed from the model and includes `.main_cos1` and `.main_sin1`
columns of data:
...
this example, the `.main_cos1` and `.main_sin1` correspond to $\hat\beta$
...
The AIC for the unpooled model is lower than the pooled model, and the difference in the fit is statistically significant, supporting a differential fit between the two levels of the grouping.
