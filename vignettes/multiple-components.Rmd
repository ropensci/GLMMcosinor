...
library(GLMMcosinor)
```
GLMMCosinor allows specification of multi-component cosinor models. This is useful if there are multiple explanatory variables affecting the dependent variable, given that their period is known. The plot below shows a 3-component model with the simulated data overlayed: 
