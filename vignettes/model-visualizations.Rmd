...
There is in built method to directly assess differential rhythmicity, the 
overall difference between two rhythms in terms of both amplitude and phase 
combined. It can be done using a likelihood ratio and is demonstrated as part 
of the [Getting started](https://docs.ropensci.org/GLMMcosinor/articles/GLMMcosinor.html)
vignette. It can also be assessed by visually inspecting the `polar_plot()` and 
