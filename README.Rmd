...
For an introduction to the cosinor model, see the [getting started vignette](https://rwparsons.github.io/GLMMcosinor/articles/GLMMcosinor.html).
...
[`{TMB}`](https://cran.r-project.org/web/packages/TMB/index.html)[@Kristensen2023TMB]
