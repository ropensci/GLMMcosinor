...
# m <- cosinor.glmm(Y ~ group+amp_acro(times, n_components = 2, group = "group", period = c(12, 12)), data = comod)
...
#
# m <- cosinor.glmm(Y ~ group+amp_acro(time, n_components = 2, group = "X", period = c(12,10)), data = dat)
#
...
# cosinor.glmm(Y ~ group+amp_acro(times, n_components = 2, group = "group", period = c(12, 8)), data = comod)
# #
...
# cosinor.glmm(Y~ X + Z + amp_acro(time, n_components = 3, group = c("X",NA,"Z"), period = c(12,10,8)),data = dat2)
#
#
...
# cosinor.glmm(Y ~ group+amp_acro(time, n_components = 2, group = "X", period = c(12,10)), data = dat)
...
# cosinor.glmm(Y ~ group+amp_acro(time, n_components = 2.1, group = "X", period = c(12,10)), data = dat)
# cosinor.glmm(Y ~ group+amp_acro(time, n_components = 0, group = "X", period = c(12,10)), data = dat)
...
# cosinor.glmm(Y ~ amp_acro(time, n_components = 2, period = c(12,10)), data = dat)
# #If you name your grouping variable anything with 'rrr' or 'sss', an error will appear
# #with relevant information.
# cosinor.glmm(Y ~ group+amp_acro(time, n_components = 2, group = "rrr", period = c(12,10)), data = dat)
#
...
#   cosinor.glmm(Y~ group + amp_acro(time, n_components = 3, group = c("X",NA,"Z"), period = c(12,10,8)),data = dat2)
#
#   #Example 2:
#   cosinor.glmm(Y ~ X+amp_acro(time, n_components = 2, group = "X", period = c(12,10)), data = vitamind)
...
#   cosinor.glmm(Y~ 0 + X + Z + amp_acro(time, n_components = 3, group = c("X",NA,"Z"), period = c(12,10,8)),data = dat)
#   cosinor.glmm(Y~ 0 + amp_acro(time, n_components = 3, group = c("X",NA,"Z"), period = c(12,10,8)),data = dat)
#
...
#     cosinor.glmm(Y~ 0 + X + amp_acro(time, n_components = 3, group = c("X",NA,"Z"), period = c(12,10,8)),data = dat)
#     #note the way the interaction terms are arranged:
#     cosinor.glmm(Y~ 0 + Z + amp_acro(time, n_components = 3, group = c("X",NA,"Z"), period = c(12,10,8)),data = dat)
#
...
#     vitamindmod$Y[2] <- NA
#     cosinor.glmm(Y ~ X + amp_acro(time, group = "X"), data = vitamindmod)
#
#     #Testing the predict function()
#     data(vitamind)
#     form = Y ~ X + amp_acro(time, group = "X")
...
#     #Ex. 1
#     object1 <- cosinor.glmm(Y ~ X + amp_acro(time, group = "X"), data = vitamind)
...
#     object2 <-    cosinor.glmm(Y~ X + amp_acro(time, n_components = 3, group = c("X",NA,"Z"), period = c(12,10,8)),data = vitamind)
...
#     object3 <- cosinor.glmm(Y ~ group+amp_acro(times, n_components = 2, group = "group", period = c(12, 8)), data = comod)
...
#     object3 <- cosinor.glmm(Y ~ group+amp_acro(times, n_components = 1, group = "group", period = 12), data = comod, family = "poisson")
#     ggplot.cosinor.glmm(object3, x_str = "group", transpose_data = TRUE)
#
#     comod = simulate_cosinor(1000,mesor = 1,amp = 2,acro = 3,beta.mesor = 0.5,beta.amp = 1, beta.acro = 0.3, family = "gamma")
#     object3 <- cosinor.glmm(Y ~ group+amp_acro(times, n_components = 1, group = "group", period = 12), data = comod, family = "Gamma"(link = "log"))
#     ggplot.cosinor.glmm(object3, x_str = "group", transpose_data = TRUE, data_opacity = 0.1)
#
#
#
   #polar plots in progress: (proof of concept)
   object1 <- cosinor.glmm(Y ~ 0 + amp_acro(time), data = vitamind)
   summary.cosinor.glmm(object1)
   #ggplot.cosinor.glmm.polar(object1)
   test_cosinor(object1, x_str = "X")

   object1 <- cosinor.glmm(Y ~ 1 + X +amp_acro(time, group = "X"), data = vitamind)
   summary.cosinor.glmm(object1)
   ggplot.cosinor.glmm.polar(object1)
   test_cosinor(object1, x_str = "X")
#
#
     ...
     object2 <-    cosinor.glmm(Y~ X + amp_acro(time, n_components = 3, group = c("Z",NA,"X"), period = c(12,10,8)),data = vitamind)
...
object3 <- cosinor.glmm(Y ~ group+amp_acro(times, n_components = 2, group = "group", period = c(12, 8)), data = comod,
                        dispformula = ~ group + amp_acro(times, n_components = 2, group = "group", period = c(12, 8)),
                        ziformula = ~ group + amp_acro(times, n_components = 2, group = "group", period = c(12, 8)))
summary.cosinor.glmm(object3)
...
object4 <- cosinor.glmm(Y ~ X + amp_acro(time, n_components = 1, group = "X", period = 12), data = vitamind,
                        dispformula = ~ X + amp_acro(time, n_components= 1, group = "X", period = 12),
                        ziformula = ~ X + amp_acro(time, n_components= 1, group = "X", period = 12))
...
testdata = simulate_cosinor(1000,
                            ...
                            n_components = 3,
                            alpha = 5)
object = cosinor.glmm(Y ~ group + amp_acro(times, n_components = 3, period = c(12,6, 8), group = 'group'), data = testdata, family = Gamma(link = "log"))
...
testdata = simulate_cosinor(1000,
                            ...
                            period = c(12,6,8),
                            n_components = 3)
object = cosinor.glmm(Y ~ group + amp_acro(times, n_components = 3, period = c(12,6, 8), group = 'group'), data = testdata, family = binomial())
ggplot.cosinor.glmm(object, superimpose.data = TRUE, x_str = "group", predict.ribbon = FALSE)
...
testdata = simulate_cosinor(1000,
                            ...
                            n_components = 3,
                            sd = 1)
object = cosinor.glmm(Y ~ group + amp_acro(times, n_components = 3, period = c(12,6, 8), group = 'group'), data = testdata, family = gaussian())
ggplot.cosinor.glmm(object, superimpose.data = TRUE, x_str = "group", predict.ribbon = FALSE)
...
testdata = simulate_cosinor(100,
                            ...
                            n_components =2,
                            sd = 1)
object = cosinor.glmm(Y ~ group + amp_acro(times,n_components = 2, period = c(10,12), group = 'group'), data = testdata, family = gaussian())
...
#
#> obj1 <- cosinor.glmm(Y ~ X + amp_acro(time,
#                                        +                               n_components = 3,
#                                        +                               group = "X",
#                                        +                               period = c(12, 9, 10)
